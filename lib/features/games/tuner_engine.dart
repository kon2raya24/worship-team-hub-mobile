...
///
/// `record` gives us a PCM16 microphone stream; pitch detection is done here in
/// Dart with the same autocorrelation (ACF2+ + parabolic interpolation) the web
/// uses. The O(n²) correlation is throttled to ~10/sec so it doesn't jank the
/// UI thread (a future optimisation could move it to an isolate).
